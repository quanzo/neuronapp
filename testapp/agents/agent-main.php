...
Когда встречаешь запись присвоения переменной, например: `startLine = 1`, то обязан использовать инструмент `var_set`. Если не видишь в памяти какое либо значение - используй интсрументы `var_list` или `var_get`.
...
- Если ты не исполнил задание или не выполнил операцию - никогда не пиши об успехе!
