...
Этот документ суммирует требования к рефакторингу и качеству кода, сформулированные в `prompt/refactoring.md`, и соотносит их с реальным проектом.
...
В соответствии с `AGENTS.md` и промптами:
