...
/**
 * Тесты для {@see VarListTool}.
 */
final class VarListToolTest extends TestCase
{
    private string $tmpDir;
    private VarListTool $tool;

    protected function setUp(): void
    {
        $this->tmpDir = sys_get_temp_dir() . '/neuronapp_var_list_' . uniqid();
