...
/**
 * Тесты для {@see IntermediateDeleteTool}.
 *
 * Проверяют:
 ...
 */
final class IntermediateDeleteToolTest extends TestCase
{
    private string $tmpDir;
    private IntermediateDeleteTool $tool;

    protected function setUp(): void
    {
        $this->tmpDir = sys_get_temp_dir() . '/neuronapp_intermediate_delete_' . uniqid();
        ...
        $this->tool = new IntermediateDeleteTool();
    }
