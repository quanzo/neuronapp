...
/**
 * Вспомогательный класс для семантического разбиения Markdown на чанки.
 *
 * Сохраняет целостность таблиц, абзацев, списков и связанных с ними заголовков,
 * чтобы чанк оставался читаемым даже при отклонении от целевого размера.
 *
 * Пример использования:
 * `MarkdownChunckHelper::chunkBySemanticBlocks($markdown, 1200);`
 */
